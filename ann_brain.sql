...
INSERT INTO 'projects'('title', 'subtitle','year','location',`industry`,`area`,`status`,`content`) VALUES ('Static Web Development','CMT119 Coursework','2023','Cardiff','Web Development','0','Conceptual Project','In this coursework, I employed Computational Thinking to deconstruct complex problems, methodically creating a mind map that laid the foundation for my websites framework. I designed the page layout in PowerPoint before translating it into HTML and CSS, which deepened my understanding of web development and logical problem-solving. The website features an introduction to Computational Thinking, its relevance to my studies and career, a biography of a notable computer scientist, and a reflective piece on the modules impact on my education. This work not only honed my technical skills but also reinforced the significance of structured analysis in computing. - Website URL: https://main--polite-taffy-2f3d79.netlify.app/');
